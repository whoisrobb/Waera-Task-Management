...
exports.updateUserdata = exports.loginUser = exports.createUser = exports.getAllUsers = void 0;
...
const updateUserdata = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield db_1.default.update(schema_1.UserTable)
            .set({
            firstName: firstName,
            lastName: lastName,
            domain: domain,
            ...
            .returning({
            userId: schema_1.UserTable.userId,
            firstName: schema_1.UserTable.firstName,
            lastName: schema_1.UserTable.lastName,
            email: schema_1.UserTable.email,
            domain: schema_1.UserTable.domain,
            description: schema_1.UserTable.description,
            avatar: schema_1.UserTable.avatar,
        });
        res.status(200).json(Object.assign(Object.assign({}, user[0]), { initials: initials(user[0].firstName, user[0].lastName) }));
    }
    catch (err) {
